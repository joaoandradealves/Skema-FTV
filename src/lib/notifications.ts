...
export type NotificationType = 'registration' | 'plan_request' | 'day_use' | 'court_rental' | 'plan_approved' | 'booking_confirmed' | 'teacher_new_student' | 'booking_cancelled' | 'teacher_booking_cancelled' | 'waitlist_promoted';
